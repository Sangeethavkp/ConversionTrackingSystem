					...
					$record = array_combine($header, $importdata);	
                       // if($i > 0) {
							$data = array(
								...
								'unitPricePerPage' => isset($record["unitPricePerPage"]) ? $record["unitPricePerPage"] : NULL, 
								'unitPricePerArticle' => isset($record["unitPricePerArticle"]) ? $record["unitPricePerArticle"] : NULL, 
								'totalPages' => isset($record["totalPages"]) ? $record["totalPages"] : NULL, 
								'totalArticles' => isset($record["totalArticles"]) ? $record["totalArticles"] : NULL, 
								'totalPagesPrice' => isset($record["totalPagesPrice"]) ? $record["totalPagesPrice"] : NULL, 
								'totalArticlesPrice' => isset($record["totalArticlesPrice"]) ? $record["totalArticlesPrice"] : NULL, 
								'projectid' => isset($record["projectid"]) ? $record["projectid"] : NULL, 
								'start_date' => isset($record["start_date"]) ? $record["start_date"] : NULL, 
								'due_date' => isset($record["due_date"]) ? $record["due_date"] : NULL, 
